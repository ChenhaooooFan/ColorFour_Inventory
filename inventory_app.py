...
if selected_pdfs and csv_file:
    ...
    # —— 逐个 PDF 识别 Item quantity（保持原来的识别方式与正则）——
    pdf_item_list = []
    ...
    # 对账（与“各 PDF Item quantity 合计”对比）
